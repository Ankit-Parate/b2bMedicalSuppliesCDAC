...
<head>
  ...
  <h2 class="text-center text-white text-monospace mb-2">b2b Medical Supplies</h2>
</head>
              ...
              <form action="register" method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <div class="dropdown">
                    	...
                    	<span id="temptype" class="text-danger font-weight-bold"></span>
					  <!-- 
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <span id="repeatpassword" class="text-danger font-weight-bold"></span>
                  </div>
                </div>
                <div class="form-group">
                  <textarea class="form-control form-control-user" name="tempAddr" id="tempAddr" placeholder="Address"></textarea>
                  <span id="tempaddr" class="text-danger font-weight-bold"></span>
                </div>
                <div class="form-group">
                  <input type="number" class="form-control form-control-user" name="tempPhoneNo" id="tempPhoneNo" placeholder="Phone number" pattern="[0-9]{10}">
                  <span id="tempphoneno" class="text-danger font-weight-bold"></span>
                </div>
                <div class="form-group">
                  ...
                  <span id="tempmailid" class="text-danger font-weight-bold"></span>
                </div>
                <div class="form-group">
                  <input type="file" name="file" class="btn btn-success btn-user btn-block file" id="file">
                  <span id="templicense" class="text-danger font-weight-bold"></span>
                </div>
               
                <input class="btn btn-warning btn-user btn-block" type="reset" > 
                <input onclick="return validation()" class="btn btn-primary btn-user btn-block" type="submit" value="Register">
               
               
               <script>
               
               function validation(){
	      			 		   var usertype=document.getElementById('tempType').value;
	                           var user=document.getElementById('tempName').value;
	                           var pass=document.getElementById('tempPass').value;
	                           var conpass=document.getElementById('repeatPassword').value;
	                           var addr=document.getElementById('tempAddr').value;
	                           var mobile=document.getElementById('tempPhoneNo').value;
	                       	   var email=document.getElementById('tempMailId').value;
                               ...
                               if(mobile==""){
                            	   document.getElementById('tempphoneno').innerHTML ="phone no is required";                                   
                                   return false;
                               }else{
                            	   document.getElementById('tempphoneno').innerHTML ="";
                               }
                               if(isNaN(mobile)){
                            	   document.getElementById('tempphoneno').innerHTML ="phone no must be digits only";                           	   
                                   return false;
                               }else{
                            	   document.getElementById('tempphoneno').innerHTML ="";
                               }
                               ...
                               if(mobile.length!=10){
                            	   document.getElementById('tempphoneno').innerHTML ="phone no must be 10 digits only";
                                   return false;
                               }else{
                            	   document.getElementById('tempphoneno').innerHTML ="";
                               }
                               ...
                               if(email==""){                            	  
                                   document.getElementById('tempmailid').innerHTML ="email id is required";
                                   return false;
                               }else{
                            	   document.getElementById('tempmailid').innerHTML ="";
                               }
                             
                               if(file==""){                               
                                   document.getElementById('templicense').innerHTML ="please attach file";
                                   document.getElementById('file').focus();
                                   return false;
                               }else{
                            	   document.getElementById('templicense').innerHTML ="";
                               }
