    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Update Details<br><br> Username cannot be changed</h1>
			
			<form action="pharmacyDetailsPagePost" method="post">
			     <div class="form-group col-sm-6">
			     <span class="font-weight-bold">User Name</span>
                    <input type="text" readonly="readonly" class="form-control form-control-user" name="pharName" id="pharName" value="${pharName }">
                  </div>
			     <div class="form-group col-sm-6">
			     <span class="font-weight-bold">Password</span>
                    <input type="password" class="form-control form-control-user" name="pharPass" id="pharPass" value="${pharPass }">
                  </div>
                  <div class="form-group col-sm-6">
                  <span class="font-weight-bold">Repeat Password</span>
                    <input type="password" class="form-control form-control-user" id="repeatPassword" value="${pharPass }">
                  </div>
                <div class="form-group col-sm-6">
                <span class="font-weight-bold">Address</span>
                  <input type="text" class="form-control form-control-user" name="pharAddress" id="pharAddress" value="${pharAddress }">
                </div>
                <div class="form-group col-sm-6">
                <span class="font-weight-bold">Phone No</span>
                  <input type="number" class="form-control form-control-user" name="pharPhoneNo" id="pharPhoneNo" value="${pharPhoneNo }">
                </div>
                <div class="form-group col-sm-6">
                <span class="font-weight-bold">Email ID</span>
                  <input type="email" class="form-control form-control-user"  aria-describedby="emailHelp" name="pharMailId" id="pharMailId" value="${pharMailId }">
                </div>
