          ...
          <h1 class="h3 mb-4 text-gray-800">Update Product</h1>
			...
			<form action="manufacturerUpdateProduct" method="post">
			     ...
			     <span class="font-weight-bold">Product Name</span>
                    <input type="text" class="form-control form-control-user" name="prodName" id="prodName" value="${product.prodName} ">
                  </div>
			     <div class="form-group col-sm-6">
			     <span class="font-weight-bold">Product Cost</span>
                    <input type="text" class="form-control form-control-user" name="prodCost" id="prodCost" value="${product.prodCost}">
                  </div>
                  <div class="form-group col-sm-6">
                  <span class="font-weight-bold">Product Quantity</span>
                    <input type="text" class="form-control form-control-user" name="prodQuantity" id="prodQuantity" value="${product.prodQuantity}">
                  </div>
                  <input type="hidden" class="form-control form-control-user" name="prodId" id="prodId" value="${product.prodId}">
                <input class="form-group col-sm-6 btn btn-primary btn-user btn-block" type="submit" value="Update Product">
