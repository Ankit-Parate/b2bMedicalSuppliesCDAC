  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Begin Page Content -->
       <div> <h1 class="h3 mb-4 text-gray-800" style="padding-left: 10px">Order History</h1></div>
       <div class="container" style="height: 69vh">
        
       <c:forEach items = "${ilist}" var = "orders" >
        <div class="container-fluid bg-gradient-primary " class="rounded" style="height:27vh; width:100vh ; border-radius: 25px; opacity: 1" >
      ...
      <div class="row" align="center"> 
      	...
      	<div class="col-lg-6" align="left" style="padding-left: 60px; padding-top:12px ; color: white;">
       		<div>
        		<!--  <div><b>Order Id</b><pre></pre><p style="width: 300px" name="orderId">Order</p></div><br> -->
		        <div><b>Product Name</b><pre></pre><p style="width: 300px" name="productName" >${orders.prodName}</p></div><br>
		        <div><b>Manufacturer Name</b><pre></pre><p style="width: 300px" name="manufacturerName">${orders.manuName}</p></div>
     		</div>
     	</div>
    
      	<div class="col-lg-6 " align="left" style="padding-left: 150px; padding-top:12px ; color: white;">
		    <div>
		        <div><b>Cost</b><pre></pre><p style="width: 300px" name="cost">${orders.orderCost}</p></div><br>
		        <div><b>Quantity</b><pre></pre><p style="width: 300px" name="quantity">${orders.orderQuant}</p></div><br>
